...
const server = https.createServer({
    key: fs.readFileSync("/etc/letsencrypt/live/funishment.swagslash.io/privkey.pem"),
    cert: fs.readFileSync("/etc/letsencrypt/live/funishment.swagslash.io/cert.pem")
}, app);
