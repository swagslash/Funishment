<script lang="ts">
    ...
    export let playerCards: Card[] = []
    export let canPlay = false;

    function submitPlayedCard(e: Event) {
        // TODO send to server
        canPlay = false;
    }
</script>
...
<h3>My Cards</h3>
<p class="badge bg-warning text-black-50" hidden={!canPlay}>Select one of your cards as answer for this question now!</p>
